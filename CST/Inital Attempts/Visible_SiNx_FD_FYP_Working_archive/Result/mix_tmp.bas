...
Dim NumObject_13_1 As Object
Set NumObject_13_1 = GetRes1DComplexFrom1DCNumeric(1,0,callingApp)
NumObject_13_1.MakeCompatibleTo(A_cst_tmp)
Dim TmpResult_13 As Object
Set TmpResult_13 = NumObject_13_1.Copy()
TmpResult_13.ComponentMult(A_cst_tmp)
