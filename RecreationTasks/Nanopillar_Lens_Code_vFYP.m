...
%% The start of the phase map code
                FileName = sprintf('Lens_0.42_f2_prac.txt');        %the file name, can modify to be based on date, time etc
                ...
                f=820;    %focal length in um

                pix=420;  %aperture or lens diameter size in um

                lambda = 0.561;    %this is the wavelength in um for the equation

                sizes =importdata('SiNx 10 pillars at 561nm.txt');     %this is where you input the data file from CST with your pillar and corresponding phase values
%                 sizes = sizes(:,1)
